...
$(window).on("load", async function () {
  ...
  showMessage(
    "message-4",
    "<strong>INFO: </strong>We have updated our api. Its now faster and dont have so many errors. If you want to use it <a href='https://github.com/Lixqa/DiscordPomelo#API'>click here</a> for the docs."
  );
